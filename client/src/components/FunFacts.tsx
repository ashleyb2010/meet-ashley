...
const funFacts = [
  {
    ...
    detail: "Named after the hobbit (obviously). My adventure buddy, couch companion, and the real boss of the house.",
  ...
  },
  {
    ...
    detail: "Always exploring the latest in wellness and biohacking. Red light therapy is my current obsession — it's the little optimizations that add up.",
  ...
  },
  {
    ...
    detail: "And it's only March. When you support a global org, the world becomes your office. Every trip is a chance to learn something new about how people connect.",
  ...
  },
  {
    ...
    detail: "I can introduce myself in Navajo (from my international high school in Arizona) and speak functional Spanish from my time in Madrid. Languages are windows into cultures.",
  ...
  },
  {
    ...
    detail: "Lily is my best friend from high school's daughter. Being her godmother is one of my proudest titles — right up there with Fulbright Fellow.",
  ...
  },
  {
    ...
    detail: "My honors thesis at Claremont McKenna was called 'XOXO: A Linguistic Analysis of Electronic Flirtation.' I studied how people flirt online before it was cool (or creepy).",
    color: "oklch(0.62 0.14 45)",
    bgColor: "oklch(0.62 0.14 45 / 0.08)",
  },
  {
