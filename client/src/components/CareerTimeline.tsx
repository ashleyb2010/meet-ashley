...
const milestones = [
  ...
  },
  {
    ...
    role: "Fellow to Colombia",
    description: "Selected by the U.S. Department of State as a J. William Fulbright Fellow. An experience that cemented my commitment to cross-cultural understanding and global perspective.",
  ...
  },
  {
    ...
    description: "The beginning of a 12+ year journey. Started as a contract admin supporting three HR Business Partners. Helped plan a global HR meeting for 250+ people. I was hooked.",
    accent: "oklch(0.65 0.08 145)",
    side: "left" as const,
  },
  {
    ...
    description: "Eight years supporting a VP with a team of 600+ across five global offices and four product groups. Orchestrated complex international travel, led product cycle logistics, drafted CEO briefings, and mentored a team of thirteen admins. This is where I became a force multiplier.",
    accent: "oklch(0.72 0.14 70)",
    side: "right" as const,
  },
  {
    ...
    description: "Now supporting the COO across an org of 35,000+ employees. I grew and manage a global team of EAs, program managers, and project managers. I orchestrate regional visits across APAC, EMEA, the Americas, and Latin America. I manage executive presence at the World Economic Forum, Cannes, Mobile World Congress, and Sun Valley. I build the infrastructure that makes the office run.",
    accent: "oklch(0.62 0.14 45)",
    side: "left" as const,
  },
];
